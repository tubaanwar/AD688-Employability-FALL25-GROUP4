...
plt.tight_layout()
plt.savefig("./figures/Missing-values-Heatmap.png")
plt.show()
...
plt.tight_layout()
plt.savefig("./figures/Top-10-Job-Titles-by-Postings.png")
plt.show()
...
for i, v in enumerate(employment_counts):
    ax.text(v + 50, i, str(v), va='center', fontweight='bold')
plt.tight_layout()
plt.savefig("./figures/Job-posting-by-employment-type.png")
plt.show()
...
plt.tight_layout()
plt.savefig("./figures/Job-Market-Distribution-remotevs-onsite.png" )
plt.show()
