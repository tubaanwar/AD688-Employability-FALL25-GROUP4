...
plt.tight_layout()
plt.savefig("./figures/Missing-values-Heatmap.pnj")
plt.show()
...
plt.tight_layout()
plt.savefig("./figures/Top 10-Job-Titles-by-Postings(2024).pnj")
plt.show()
...
for i, v in enumerate(employment_counts):
    ax.text(v + 50, i, str(v), va='center', fontweight='bold')
plt.tight_layout()
plt.savefig("/.figure/Job-posting by-employment-type.png")
plt.show()
...
plt.tight_layout()
plt.savefig(./figure/Job-Market-Distribution-remotevsonsite.png )
plt.show()
